...
def initialize_telemetry():
    ...
    try:
        ...
        use_always_on = is_development or (
            sampling_ratio_override and float(sampling_ratio_override) == 1.0)
        # Default 10% for production
        ...
        logger.warning(
            "⚠️ Install with: pip install opentelemetry-api opentelemetry-sdk opentelemetry-exporter-otlp-proto-http")
        return False
