...
// Vercel's Root Directory is set to rpa-system/, so we're running from there
// The dashboard is at rpa-dashboard/ relative to rpa-system/
const rootDir = process.cwd();
const possibleDirs = [
  path.join(rootDir, 'rpa-dashboard'),           // When running from rpa-system/
  path.join(rootDir, 'rpa-system', 'rpa-dashboard'), // Fallback: if running from repo root
  path.join(rootDir, '..', 'rpa-system', 'rpa-dashboard') // Another fallback
];
