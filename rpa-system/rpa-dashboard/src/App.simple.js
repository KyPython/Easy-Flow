            ...
            {currentPage === 'dashboard' && (
              <div>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px', marginBottom: '30px' }}>
                  {[
                    { title: 'Active Workflows', value: '12', color: '#10b981' },
                    { title: 'Team Members', value: '8', color: '#3b82f6' },
            ...
            {currentPage === 'analytics' && (
              <div>
                ...
                <div style={{ marginTop: '20px' }}>
                  ...
                  <div style={{ padding: '20px', backgroundColor: '#f0f8ff', borderRadius: '8px', marginTop: '15px' }}>
                    <h4>Quick Actions:</h4>
                    <button style={{ margin: '5px', padding: '8px 16px', backgroundColor: '#3b82f6', color: 'white', border: 'none', borderRadius: '4px' }}>
                      Generate Report
                    </button>
                    <button style={{ margin: '5px', padding: '8px 16px', backgroundColor: '#10b981', color: 'white', border: 'none', borderRadius: '4px' }}>
                      Export Data
                    </button>
                  </div>
                </div>
            ...
            {currentPage === 'schedules' && (
              <div>
                ...
                <div style={{ marginTop: '20px' }}>
                  ...
                  <div style={{ padding: '20px', backgroundColor: '#fff7ed', borderRadius: '8px', marginTop: '15px' }}>
